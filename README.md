...
- [x] Make a podium for top 3 of a ctf?

- [x] Ability to remove challenges

- [ ] finish moving ctf challenges to the same structure as /challenges

- [ ] make everything resolve:able

- [ ] dry everything up

- [ ] more typing of component props
