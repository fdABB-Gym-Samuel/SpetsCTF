...
<main class="w-full pt-12 sm:m-auto" bind:this={content}>
            ...
            <div class="flex gap-2 xl:hidden">
                ...
                <div class="flex w-full items-center justify-between">
                    <div
                        ...
                        <!-- Tab buttons -->
                        <a
                            href={resolve(`/ctf/${ctfData.id}/challenges`)}
                            class="relative z-10 flex w-[calc(100%/3)] flex-1 items-center justify-center rounded-lg px-4 py-2 text-sm transition-colors duration-300"
    ...
    {#if currentTab === 0}
        <ChallengeList
            gotoChallenge={(challengeId) => {
                goto(resolve(`/ctf/${ctfData?.id}/challenges/${challengeId}`));
            }}
    ...
    {:else if currentTab === 1}
        ...
        {:else}
            <p>Sign in to create a challenge.</p>
