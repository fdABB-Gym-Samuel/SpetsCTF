        ...
        <section class="mb-8 flex h-80 w-full items-end justify-center">
            {#each [2, 0, 1] as idx, i (idx)}
                <div class="flex h-full w-1/3 flex-col items-center justify-end">
                    ...
                    <div
                        class="w-full overflow-hidden rounded-t-md text-center"
                        ...
                        {i === 0
                                        ...
                                        : i === 1
                                          ...
                                          : i === 2
                                            ...
                                            : ''}"
                                    class:bg-bg-700={team &&
                                        team.teamId === teamInside.team_id}>
                                    <td
                                    ...
                                    <td
                                        ...
                                        >{teamInside.total_points == null
                                            ? 0
                                            : teamInside.total_points}</td>
                                </tr>
                            {/each}
                        </tbody>
                    </table>
