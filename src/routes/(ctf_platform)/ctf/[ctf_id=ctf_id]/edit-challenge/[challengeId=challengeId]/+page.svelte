	...
	>
		<div class="mb-5 flex flex-col">
			...
			<input
				...
				bind:value={editableChallenge.challenge_name}
			/>
		</div>
		<div class="mb-5 flex flex-col">
			...
			<textarea
				...
				bind:value={editableChallenge.challenge_description}
			></textarea>
		</div>
		<div class="mb-5 flex flex-col">
			...
			<input
				...
				bind:value={editableChallenge.flag}
			/>
		</div>
		<div class="mb-5 flex flex-col">
			...
			<input
				...
				bind:value={editableChallenge.flag_format}
			/>
		</div>
		<div class="mb-5 flex flex-col">
			...
			<input
				...
				bind:value={editableChallenge.points}
			/>
		</div>
		<div class="mb-5 flex flex-col">
