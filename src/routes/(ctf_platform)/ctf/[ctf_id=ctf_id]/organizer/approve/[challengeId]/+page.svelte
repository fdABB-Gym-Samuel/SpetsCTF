	...
	>
		<div class="mb-5 flex flex-col">
			...
			<input
				...
				bind:value={unapprovedChallenge.challenge_name}
			/>
		</div>
		<div class="mb-5 flex flex-col">
			...
			<textarea
				...
				bind:value={unapprovedChallenge.challenge_description}
			></textarea>
		</div>
		<div class="mb-5 flex flex-col">
			...
			<input
				...
				bind:value={unapprovedChallenge.flag}
			/>
		</div>
		<div class="mb-5 flex flex-col">
			...
			<input
				...
				bind:value={unapprovedChallenge.flag_format}
			/>
		</div>
		<div class="mb-5 flex flex-col">
			...
			<input
				...
				bind:value={unapprovedChallenge.points}
			/>
		</div>
		<div class="mb-5 flex flex-col">
